...
/**
 * Shared Cloth Config screen builder. Used by the Fabric Mod Menu hook and the NeoForge
 * IConfigScreenFactory extension point so both loaders show the same in-game settings screen.
 */
public final class DuraPingConfigScreen {
    private DuraPingConfigScreen() {}
